...
def ResNet9Narrow(num_classes=10, channels_last=False, mul=0.4):
    return resnet9.ResNet9Mul(num_classes, channels_last=channels_last, mul=mul)

def ResNet9Wide(num_classes=10, channels_last=False, mul=2.):
    return resnet9.ResNet9Mul(num_classes, channels_last=channels_last, mul=mul)

CIFAR_RESNETS = {
    'resnet9': ResNet9,
    'resnet9wide': ResNet9Wide,
    'resnet9narrow': ResNet9Narrow,
    'resnet50': ResNet50,
    'resnet18': ResNet18,
    'resnet34': ResNet34,
    'resnet101': ResNet101,
